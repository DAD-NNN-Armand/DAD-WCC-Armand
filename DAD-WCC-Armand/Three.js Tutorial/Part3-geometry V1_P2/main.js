...
var materialCapsule = new THREE.MeshBasicMaterial({ color: 0x4927f5 }); // Crée un matériau simple
...
var materialCone = new THREE.MeshBasicMaterial({ color: 0xf5276c }); // Crée un matériau simple
...
var materialIcosahedron = new THREE.MeshBasicMaterial({ color: 0x8000ff });
...
var materialOctahedron = new THREE.MeshBasicMaterial({ color: 0x00ffff });
...
var materialPlane = new THREE.MeshBasicMaterial({ color: 0x80ff00 });
...
var materialRing = new THREE.MeshBasicMaterial({ color: 0x00ff00 });
...
var materialSphere = new THREE.MeshBasicMaterial({ color: 0x0080ff });
...
var materialTetrahedron = new THREE.MeshBasicMaterial({ color: 0xff00ff });
...
var materialTorus = new THREE.MeshBasicMaterial({ color: 0xff8000 });
...
var materialDodecahedron = new THREE.MeshBasicMaterial({ color: 0xffffff });
